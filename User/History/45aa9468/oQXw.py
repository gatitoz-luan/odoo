    ...
    def _action_confirm(self):
        ...
        for order in self:
            for line in order.order_line:
                ...
                date_planned = line.customer_lead  # Este é um exemplo, ajuste conforme necessário

                # Aqui você chama sua função de reabastecimento
                # Você precisará ajustar isso para corresponder à assinatura do método real e lógica esperada
