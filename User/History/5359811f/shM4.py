    ...
    def create_return_picking(self):
        ...
        for order in self:
            picking = Picking.create({
                ...
                'origin': order.name,
                'scheduled_date': order.rental_end_date,
            })
            for line in order.order_line:
                Move.create({
                    'name': line.name,
    ...
    def action_confirm(self):
        ...
        for order in self:
            ...
            for line in order.order_line:
                ...
                if product_cleaning_time > max_cleaning_time:
                    max_cleaning_time = product_cleaning_time
        
        if order.rental_end_date and max_cleaning_time:
            replenish_date = order.rental_end_date + timedelta(days=max_cleaning_time)
