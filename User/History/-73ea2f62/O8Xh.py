...
class SaleOrderLine(models.Model):
    ...
    locked = fields.Boolean(related='order_id.locked', string='Locked', readonly=True)
    authorized_transaction_ids_related = fields.Many2many(related='order_id.authorized_transaction_ids', string='Authorized Transactions')
