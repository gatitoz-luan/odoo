...
def _compute_rental_values(self):
    for line in self:
        ...
        if rental_start and rental_end:
            ...
            # Calcula o subtotal com base no preço de locação, na duração e na quantidade
        ...
        # Calcula os impostos
        if line.tax_id:
            taxes = line.tax_id.compute_all(price_unit, line.order_id.currency_id, line.product_uom_qty * rental_duration, product=line.product_id, partner=line.order_id.partner_id)
