    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        ...
        for line in self:
           if line.state == 'sale' and line.product_id.type in ('consu', 'product'):
                ...
                if rental_end_date:
                    # Certifique-se de que rental_end_date seja convertido para date, se necessário
                    if isinstance(rental_end_date, datetime):
                        rental_end_date = rental_end_date.date()
                    if isinstance(rental_end_date, date) and rental_end_date > date_planned.date():
                ...
                # Obtenção do product_uom_id do produto
