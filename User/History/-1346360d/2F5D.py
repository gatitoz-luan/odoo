        ...
        for line in self:
            ...
            try:
                if line.state == 'sale' and line.product_id.type in ('consu', 'product'):
                    # Inicializa date_planned como hoje (como objeto datetime)
                    date_planned = fields.Datetime.now()

                    # Converte rental_end_date e date_planned para objetos date se estiverem como datetime
                    rental_end_date = line.order_id.rental_end_date
                    if rental_end_date and isinstance(rental_end_date, datetime):
                        rental_end_date = rental_end_date.date()

                    if rental_end_date and rental_end_date > date_planned.date():
