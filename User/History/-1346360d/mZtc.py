    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        for line in self:
            if line.state == 'sale' and line.product_id.type in ('consu', 'product'):
                # Assume-se que rental_end_date é um fields.Datetime ou None
                date_planned = line.order_id.rental_end_date or fields.Datetime.now()
                
                # Verifica se cleaning_time é um número inteiro e ajusta date_planned
